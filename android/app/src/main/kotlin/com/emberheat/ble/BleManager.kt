...
import com.emberheat.protocol.ProtocolRegistry
import com.emberheat.protocol.heatgenie.HeatGenieProtocol
import com.emberheat.protocol.hcalory.HcaloryProtocol
...
class BleManager(private val ctx: Context) {
    ...
    private fun com.emberheat.protocol.CommonRunningMode.toHeatGenieRunningMode(): RunningMode = when (this) {
        com.emberheat.protocol.CommonRunningMode.STANDBY    -> RunningMode.Standby
        com.emberheat.protocol.CommonRunningMode.STARTING   -> RunningMode.Ignition
        com.emberheat.protocol.CommonRunningMode.RUNNING    -> RunningMode.AutoRun
        com.emberheat.protocol.CommonRunningMode.VENT,
        com.emberheat.protocol.CommonRunningMode.BLOWER_ONLY -> RunningMode.Ventilation
        com.emberheat.protocol.CommonRunningMode.SHUTDOWN   -> RunningMode.Cooldown
        com.emberheat.protocol.CommonRunningMode.FAULT      -> RunningMode.Fault
        com.emberheat.protocol.CommonRunningMode.MANUAL_PUMP -> RunningMode.ManualPump
