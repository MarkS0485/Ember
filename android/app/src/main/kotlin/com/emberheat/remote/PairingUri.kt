...
//   ember://pair?u=<percent-encoded https URL>&k=<keyId>&s=<base64url secret>&t=<cert sha256 hex>
//
...
object PairingUri {
    ...
    fun parse(raw: String): PairingPayload? {
        ...
        if (!scheme.equals("ember", ignoreCase = true)) return null

        // Find the ? that starts the query string. Everything between
        // the scheme and the ? is "ember://[/]pair[/]" — we don't care
