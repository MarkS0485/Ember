...
//   --color-ember-navy:      #012169
//   --color-ember-red:       #C8102E
//   --color-ember-burgundy:  #6b0c1c
// Body background:          #F1F3F9 with corner radial gradients of those three.
val EmberNavy     = Color(0xFF012169)
val EmberNavyDk   = Color(0xFF0A1F6B)
val EmberRed      = Color(0xFFC8102E)
val EmberRedDk    = Color(0xFF9B0D23)
val EmberBurgundy = Color(0xFF6B0C1C)
