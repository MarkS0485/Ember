...
private val TsgbLight = lightColorScheme(
    primary               = TsgbRed,
    onPrimary             = Color.White,
    primaryContainer      = Color(0xFFFFE4E6),
    onPrimaryContainer    = TsgbBurgundy,
    secondary             = TsgbNavy,
    onSecondary           = Color.White,
    secondaryContainer    = Color(0xFFDBE2F1),
    onSecondaryContainer  = TsgbNavyDk,
    tertiary              = OkGreen,
...
@Composable
fun TsgbTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = TsgbLight,
        typography  = TsgbTypography,
        content     = content,
    )
}
