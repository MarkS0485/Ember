...
import uk.co.twinscrollgridbalancer.tsgbheater.widget.HeaterWidgetUpdater
...
class HeaterService : LifecycleService() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        when (intent?.action) {
            ...
            //     -n uk.co.twinscrollgridbalancer.tsgbheater/.service.HeaterService \
            //     -a tsgbheater.action.DEBUG_SEND_HEX --es hex "AA 00 66 05 00 F4"
            ...
            ACTION_DEBUG_VERBOSE_RX -> {
                ...
                runCatching {
                    ...
                    val conn = field.get(ble) as uk.co.twinscrollgridbalancer.tsgbheater.ble.HeaterConnection
                    conn.verboseRx = on
    ...
    companion object {
        ...
        const val ACTION_WIDGET_HEATER_ON  = "tsgbheater.action.WIDGET_HEATER_ON"
        const val ACTION_WIDGET_HEATER_OFF = "tsgbheater.action.WIDGET_HEATER_OFF"
        const val ACTION_WIDGET_BLOWER_ON  = "tsgbheater.action.WIDGET_BLOWER_ON"
        const val ACTION_WIDGET_BLOWER_OFF = "tsgbheater.action.WIDGET_BLOWER_OFF"

        const val ACTION_DEBUG_SEND_HEX        = "tsgbheater.action.DEBUG_SEND_HEX"
        const val ACTION_DEBUG_DUMP_TELEMETRY  = "tsgbheater.action.DEBUG_DUMP_TELEMETRY"
        const val ACTION_DEBUG_VERBOSE_RX      = "tsgbheater.action.DEBUG_VERBOSE_RX"
