...
public static class FaultCodes
{
    public static readonly IReadOnlyList<HeaterFault> All = new[]
    {
        ...
        new HeaterFault(4,  "E-05", "Machine overheating",            "Housing temp > 260  degC; check inlet/outlet blockage."),
        ...
        new HeaterFault(11, "E-12", "Controller overtemperature",     "Controller temp > 100  degC; check inlet/outlet or ECU damage."),
